...
import { getDevicesForOwner, createPendingDevice, computeArmedState } from "@/lib/mongodb";
...
export async function GET() {
  ...
  const withResolvedState = devices.map((d) => ({ ...d, currentlyArmed: computeArmedState(d) }));
